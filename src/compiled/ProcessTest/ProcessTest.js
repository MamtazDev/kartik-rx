...
import Search from 'compiled/ProcessTest/subcomponents/Search';
import ProcessTestsList from 'compiled/ProcessTest/subcomponents/ProcessTestsList';
...
const ProcessTest = () => {
  ...
  return (
    <Page title='Process Tests'>
      <Header heading='Investigations' subHeading='Process Tests' />
      <Search onAction={onAction} state={state.app} />
      <ProcessTestsList onAction={onAction} state={state.app} />
